...
public:
      ...
      *
      * @param[in] pwmX  PWM Unit  - PWMA, PWMB, PWMC, PWMD, PWME or PWMF
      * @param[in] eev   external event trigger   - EEV1,EEV2, EEV3, EEV3, EEV4,
      *                  EEV5, EEV6, EEV7, EEV8, EEV9
      *
      * @warning this function must be called before initializing a timing unit
      */
      ...
      *
      * @param[in] pwmX  PWM Unit   - PWMA, PWMB, PWMC, PWMD, PWME or PWMF
      * @return     external event trigger   - EEV1,EEV2, EEV3, EEV3, EEV4,
      *                                        EEV5, EEV6, EEV7, EEV8, EEV9
      */
      ...
      *
      * @param[in] pwmX  PWM Unit - PWMA, PWMB, PWMC, PWMD, PWME or PWMF
      * @param[in] adc_trig   adc trigger - ADCTRIG_1, ADCTRIG_2, ADCTRIG_3 and
      *                       ADCTRIG_4
      *
      * @warning Call this function BEFORE enabling the adc trigger and AFTER
      *          initializing the selected timer
      */
      ...
      */
     hrtim_adc_trigger_t getAdcTrigger(hrtim_tu_number_t pwmX,
      ...
      *
      * @param[in] pwmX  PWM Unit - PWMA, PWMB, PWMC, PWMD, PWME or PWMF
      * @param[in] adc_edge_trigger  Rollover mode - EdgeTrigger_up, EdgeTrigger_down,
      *                              EdgeTrigger_Both
      *
      ...
      *
      * @param[in] pwmX  PWM Unit - PWMA, PWMB, PWMC, PWMD, PWME or PWMF
      * @return     Rollover mode - EdgeTrigger_up, EdgeTrigger_down,
      *             EdgeTrigger_Both
      */
      ...
      *        in a fixed period. For example if decimation = 1,
      * 		nothing changes but with decimation = 2
