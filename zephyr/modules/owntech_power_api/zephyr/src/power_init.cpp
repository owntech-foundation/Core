...
uint8_t dt_has_pin_driver[] = { DT_FOREACH_CHILD_STATUS_OKAY(POWER_SHIELD_ID, LEG_HAS_DRIVER)};
uint16_t dt_pin_driver[] = { DT_FOREACH_CHILD_STATUS_OKAY(POWER_SHIELD_ID, LEG_DRIVER_PIN)};
uint8_t dt_has_pin_capacitor[] = { DT_FOREACH_CHILD_STATUS_OKAY(POWER_SHIELD_ID, LEG_HAS_CAPACITOR)};
