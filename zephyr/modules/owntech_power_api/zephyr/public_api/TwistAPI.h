...
public:
	 ...
	 * @param leg_mode PWM mode - VOLTAGE_MODE or CURRENT_MODE
	 */
	void initAllMode(hrtim_switch_convention_t leg_convention, 				\
					 hrtim_pwm_mode_t leg_mode);
	...
	*/
	 ...
	 */
	void setLegSlopeCompensation(leg_t leg, 								\
	 ...
	 * @warning Be sure that set_voltage > reset_voltage
	 */
	void setAllSlopeCompensation(float32_t set_voltage, 					\
								 float32_t reset_voltage);
